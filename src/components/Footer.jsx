        ...
        <div className="footer-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10 mb-10">
          ...
          <div className="footer-brand">
            ...
            <p className="text-[0.86rem] text-[var(--text-muted)] mt-4 leading-relaxed max-w-[260px]">
              Premier interior designers in Ranchi. Transforming homes and offices across Jharkhand since 2016 — modular kitchens, full-home interiors, custom furniture and turnkey execution.
            </p>
          ...
          <div className="footer-col">
            ...
            <ul className="flex flex-col gap-2 list-none p-0">
              ...
              <li><a href="#services" className="text-[0.83rem] text-[var(--text-muted)] hover:text-[var(--orange)] transition-colors">Wardrobes</a></li>
              <li><a href="#services" className="text-[0.83rem] text-[var(--text-muted)] hover:text-[var(--orange)] transition-colors">Living & Bedroom</a></li>
              <li><a href="#services" className="text-[0.83rem] text-[var(--text-muted)] hover:text-[var(--orange)] transition-colors">Office Interiors</a></li>
              <li><a href="#services" className="text-[0.83rem] text-[var(--text-muted)] hover:text-[var(--orange)] transition-colors">Custom Furniture</a></li>
              <li><a href="#services" className="text-[0.83rem] text-[var(--text-muted)] hover:text-[var(--orange)] transition-colors">Turnkey Execution</a></li>
              <li><a href="#services" className="text-[0.83rem] text-[var(--text-muted)] hover:text-[var(--orange)] transition-colors">Balcony & Home Theatre</a></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <div className="footer-contact flex flex-col gap-2">
              <div className="footer-contact-item flex items-start gap-2 text-[0.82rem] text-[var(--text-muted)]">
                <i className="fa-solid fa-location-dot" style={{ color: "rgba(88, 88, 88, 0.67)" }}></i>
                <span>Ranchi, Jharkhand</span>
              </div>
              <div className="footer-contact-item flex items-start gap-2 text-[0.82rem] text-[var(--text-muted)]">
                <i className="fa-solid fa-phone" style={{ color: "rgba(88, 88, 88, 0.67)" }}></i>
                <span>+91 XX XXXX XXXX</span>
              </div>
              <div className="footer-contact-item flex items-start gap-2 text-[0.82rem] text-[var(--text-muted)]">
                <i className="fa-solid fa-envelope" style={{ color: "rgba(88, 88, 88, 0.67)" }}></i>
      ...
      <div className="footer-address-bar bg-black/[0.03] border-t border-black/[0.05] py-2.5 text-center">
        <div className="container mx-auto px-6">
          <p className="text-[0.73rem] text-[var(--text-muted)]">
            <i className="fa-solid fa-location-dot" style={{ color: "rgba(88, 88, 88, 0.67)" }}></i> Coceptual Studio, Your Studio Address, Ranchi, Jharkhand 834001  •  <i className="fa-solid fa-phone" style={{ color: "rgba(88, 88, 88, 0.67)" }}></i> <a href="#" className="text-[var(--orange)] font-semibold hover:underline">+91 XX XXXX XXXX </a> • <i className="fa-solid fa-envelope" style={{ color: "rgba(88, 88, 88, 0.67)" }}></i> hello@coceptualstudio.com  •  GST: XXXXXXXXXXXX
          </p>
        </div>
      </div>
    </footer >
